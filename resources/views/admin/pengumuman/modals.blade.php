...
>
    ...
    >
        ...
        <div class="px-10 py-8 border-b border-slate-50 flex items-center justify-between bg-white sticky top-0 z-20">
            <div>
                <h2 class="text-2xl font-black text-slate-800 tracking-tight" x-text="viewMode ? 'Detail Pengumuman' : (editMode ? 'Edit Pengumuman' : 'Buat Pengumuman Baru')"></h2>
                <p class="text-slate-400 text-sm font-medium mt-1" x-text="viewMode ? 'Informasi detail pengumuman.' : 'Lengkapi informasi pengumuman di bawah ini.'"></p>
            </div>
                ...
                <div class="lg:col-span-4 space-y-8">
                    ...
                    <div class="bg-slate-50 rounded-[2.5rem] p-8 space-y-4">
                        <div class="flex items-center justify-between">
                            ...
                            <label class="relative inline-flex items-center" :class="viewMode ? 'cursor-default' : 'cursor-pointer'">
                                <input type="checkbox" x-model="formData.is_permanen" class="sr-only peer" :disabled="viewMode">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input 
                                    ...
                                    :readonly="viewMode"
                                    class="w-full pl-12 pr-6 py-4 border border-slate-100 rounded-2xl focus:border-[#ba80e8] transition-all outline-none font-bold text-slate-700 text-sm shadow-sm font-mono"
        ...
        <div class="px-10 py-6 border-t border-slate-100 flex justify-between items-center bg-white sticky bottom-0 z-20">
            ...
            <button x-show="!viewMode" @click="savePengumuman()" class="flex items-center gap-3 px-10 py-4 bg-gradient-to-r from-[#ba80e8] to-[#d90d8b] text-white rounded-2xl text-sm font-black shadow-xl shadow-pink-100 hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer">
